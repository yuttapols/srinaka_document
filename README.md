...
**Customer สมัครสมาชิก+ยืนยันตัวตน** (เดิมวางแผนใช้ SMS OTP) **เปลี่ยนเป็น Google/LINE OAuth login แล้ว**
(ตัดสินใจแล้ว ไม่ใช่ assumption อีกต่อไป) — สมัครได้ 3 ทาง (กรอกเอง/Google/LINE), สมัครผ่าน Google/LINE ถือว่า
verified ทันที, สมัครกรอกเองต้องลิงก์บัญชี Google/LINE เพิ่มทีหลังถึงจะจองได้ — เป็นงานของ **Phase 2** ไม่ใช่
...
ระบบเว็บร้านสปา/นวด เน้นหน้าเว็บสวยงามให้ลูกค้าดูสินค้า/บริการ+ราคา+โปรโมชั่น, สมัครสมาชิก (กรอกเอง/Google/
LINE) +ยืนยันตัวตนแล้วจองนัด+จ่ายเงิน(แนบสลิป)+ยกเลิก/ขอคืนเงิน+ให้คะแนนร้าน/พนักงานผ่านเว็บได้ ฝั่ง Employee ยังขาย
